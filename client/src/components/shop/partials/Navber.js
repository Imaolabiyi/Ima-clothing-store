      ...
      <nav className="fixed top-0 w-full z-20 shadow-lg lg:shadow-none bg-white">
        <div className="m-4 md:mx-12 md:my-6 grid grid-cols-4 lg:grid-cols-3">
          <div className="hidden lg:block col-span-1 flex text-gray-600 mt-1">
            <span
              className="bg-red-200 px-4 py-3 font-semibold tracking-widest text-red-700 cursor-pointer"
          ...
          <div className="col-span-2 lg:hidden flex justify-items-stretch	 items-center">
            ...
            <span
              ...
              className="flex items-left text-center font-bold uppercase text-red-700 text-sm cursor-pointer px-2 text-center">
              IMA CLOTHINGS
            </span>
          </div>
          <div
            ...
            className="hidden lg:block flex items-left col-span-1 text-center text-red-700 font-bold tracking-normal uppercase text-2xl cursor-pointer">
             IMA CLOTHINGS
          </div>
          <div className="flex items-right col-span-2 lg:col-span-1 flex justify-end">
            ...
            <div
              ...
              className="hover:bg-red-300 px-2 py-2 cursor-pointer"
              title="Wishlist"
            >
              <svg
                className={`${
                  location.pathname === "/wish-list"
                    ...
                    : ""
                } w-8 h-8 text-gray-950 cursor-pointer`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
            ...
            {localStorage.getItem("jwt") ? (
              <Fragment>
                <div
                  className="userDropdownBtn hover:bg-red-300 px-2 py-2 relative"
                  title="Logout"
                >
                  <svg
                    className="cursor-pointer w-8 h-8 text-gray-950"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="userDropdown absolute right-0 mt-1 bg-red-300">
                    {!isAdmin() ? (
                      <Fragment>
                        <li className="flex flex-col text-gray-950 w-48 shadow-lg">
                          <span
            ...
            <div
              ...
              className="hover:bg-red-300 px-2 py-2 relative cursor-pointer"
              title="Cart"
            >
              <svg
        ...
        >
          <div className="col-span-1 flex flex-col text-gray-600">
            <span
              className="font-medium text-lg tracking-widest text-gray-950 hover:text-white hover:bg-red-300 px-3 py-2 cursor-pointer"
              onClick={(e) => history.push("/")}
            >
              Shop
            </span>
